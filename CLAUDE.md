# CLAUDE.md — AI Assistant Guide for "Continue"
...
### Mode 1: Content Creation / Revision
...
### Mode 2: Planning / Research

When exploring concepts or planning new content:

1. Reference [CONCEPTUAL_MAP.md](CONCEPTUAL_MAP.md) for narrative structure and the five glitch phases.
2. Reference [EMOTIONAL_ARC.md](EMOTIONAL_ARC.md) for intended reader experience.
...
When checking existing content for issues:
...
### Tier 2: Consult for Planning / Structure
...
- [guilt.md](guilt.md) — survivor/filial guilt, the unmade apology
- [apartment_clearance.md](apartment_clearance.md) — practical and procedural surface
- [the_uncanny.md](the_uncanny.md) — literary tradition and prose models

### Chapter Files (when they exist)
- Not yet created. Chapters will live in `chapters/` (to be created when drafting begins).
...
- Surfaces (counter, table, floor, shelf, sink)
- Objects (cup, kettle, dish, plate, list, phone, book, photograph, key)
- Light (the rectangle, the afternoon, morning, evening)
...
```
1. Read a page of Annie Ernaux (I Remain in Darkness or A Man's Place)
2. Read a page of Roland Barthes (Mourning Diary)
...
- A reader closes a chapter and is not sure why they are unsettled
