...
The novella is *not about* (in the sense that it does not name and does not gesture toward):

- Anything supernatural.
- Anything science-fictional.
- Anything theoretical (consciousness, simulation, memory, the unconscious, dissociation, mourning).
- Anything therapeutic (recovery, acceptance, forgiveness).
...
The 17 chapters are ordered. The order is not numbered on the page. Chapter titles are short, descriptive, and named after the task or object that organises the chapter. Two chapters share the title "The Boxes" — once early, once late. The repetition is the only typographical signal the novella permits itself.
...
## The Five Glitch Phases

The novella's central architecture is the gradual escalation of inconsistency in the apartment, in the documents, in the prose. The escalation runs in five phases. The phases are not strictly chapter-aligned: each phase dominates a stretch of the book, with anticipatory bleed forward and residual bleed back.
...
### Phase 2 — Spatial and Procedural
...
### Phase 3 — Relational and Temporal
...
**Where:** "The Inscription" through "The Boxes" (the second time) (12-15)
...
**The list in Phase 5:** Left on the counter. The novella does not look at it again.
...
## The Three Inferable Backstories

The novella never tells the reader any of the following directly. The reader assembles them from fragments. They are the three stories *behind* the novella, none of which the novella permits itself to narrate.
...
These are not stated in the novella. They are the *load* the novella carries. The chapter dossiers and the theme tracker list how each theme is manifested at the level of object, gesture, and structure.
...
A home, particularly a parent's home, is a structure of accumulated relationship — what was bought together, what was placed where, what was kept after the other person left. Clearing the home requires unpicking these accumulations. The glitches are the home refusing to be unpicked, or the unpicker refusing to perform the unpicking, or both, or neither.

### Theme 3 — Documents that fail to confirm

Bureaucracy in this novella is not antagonistic; it is bewildered. The utility company is "looking into it". The bank needs a will. The solicitor pauses on the phone. The names on the documents do not all match. The novella treats this not as comic frustration (though it is also that) but as a parallel dissolution: the *paper world* is failing to confirm reality at the same time the *physical world* is.

### Theme 4 — Things that do not glitch

Some things are stable. The crayon drawings of the child's room. The elm. The light on the counter (mostly). The first chapter's cadence in the last chapter. These anchors are crucial: without them, the dissolution has nothing to fall through. With them, the falling-through is unbearable.
...
The novella's reader, finishing the last sentence, should not feel:

- That they have been told what to feel.
